 ...
 /*  ngOnInit(): void {
  ...
  ngOnInit(): void {
    ...
    this.UnitServices.getAllUnits().subscribe((data:any)=> {
      ...
      this.numOfUnSoledUnits = this.units.filter((unit:any) => unit.status === "active").length;
      this.numOfSoledUnits = this.units.length - this.numOfUnSoledUnits;
       this.percentageActiveUnits = ((this.numOfUnSoledUnits / this.units.length) * 100).toFixed(2);
    ...
    this.UnitServices.getUnitsTwoBedrooms(2).subscribe((data:any)=> {
      ...
      this.numOfUnitsWithMoreThanTwoBedRooms= this.units.length- this.numOfUnitsWithTwoBedRooms;
      this.percentageOfUnitsWithTwoBedrooms = ((this.numOfUnitsWithTwoBedRooms / this.units.length) * 100).toFixed(2);
      this.percentageOfUnitsWithMoreThanTwoBedrooms = (100- this.percentageOfUnitsWithTwoBedrooms).toFixed(2);
